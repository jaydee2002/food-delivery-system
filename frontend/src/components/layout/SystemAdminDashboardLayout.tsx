  ...
  const navItems = [
...

    {
      ...
      submenu: [
        ...
        { label: "Restaurent Owners", path: "/customers/owner" },
        { label: "Delivery Personnel", path: "/customers/delivery" },
      ],
    },
    {
      label: "All Orders",
    ...
    <div className="flex h-screen font-sourceSans bg-gray-100">
      ...
      <div className="flex-1 flex flex-col overflow-y-auto">
        ...
        <main className="flex-1">
          <div className="py-6 px-4 sm:px-6 lg:px-8 max-w-full mx-auto h-full">
